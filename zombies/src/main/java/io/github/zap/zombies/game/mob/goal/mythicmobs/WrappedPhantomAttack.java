...
@MythicAIGoal(
        name = "unboundedPhantomAttack"
)
public class WrappedPhantomAttack extends MythicWrapper {
    public WrappedPhantomAttack(AbstractEntity entity, String line, MythicLineConfig mlc) {

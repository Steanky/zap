...
/**
 * Creates {@link Equipment}s from a {@link ZombiesPlayer} and its {@link EquipmentData} in a specific slot
 */
public interface EquipmentCreator {
     ...
     */
    <D extends @NotNull EquipmentData<@NotNull ?>> @Nullable Equipment<D, @NotNull ?> createEquipment(@NotNull ZombiesPlayer player,
                                                                                                      int slot, D data);

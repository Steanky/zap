 ...
 * Represents a skill
 */
public class Skill extends UpgradeableEquipment<SkillData> {
    ...
    public void onRightClick() {
        ...
        if (usable) {
            ...
            itemMeta.setDisplayName(getEquipmentData().getFormattedDisplayNameWithChatColor(ChatColor.RED, getPlayer(), getLevel()));

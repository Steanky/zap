...
import io.github.zap.zombies.game.shop.PowerSwitch;
...
public class NewShopForm extends CommandForm<ShopSelectionData> {
    ...
    private static final CommandValidator<ShopSelectionData, RoomSelectionData> validator = new CommandValidator<>((context, arguments, previousData) -> {
        try {
            return ValidationResult.of(false, "That is not a valid shop type!",
                    new ShopSelectionData(previousData.getPlayer(), previousData.getContext(),
                            previousData.getSelection(), previousData.getMap(), previousData.getRoom(),
